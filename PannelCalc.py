...
colors = {'코르텐블랙': '프린트', '코르텐밤색': '프린트', '헤어진회': '프린트', '헤어연회': '프린트', '헤어골드': '프린트', '빅징크': '프린트', '라인메탈 1.0*0.5': '프린트',
          '라인메탈 1.0*1.0': '프린트', '골드메탈': '프린트', '콘크리트': '프린트', '메탈스톤녹색': '프린트', '메탈스톤블루': '프린트', '메탈스톤은회': '프린트', '불소골드': '프린트',
...
colors_width = {'코르텐블랙': '1219,607', '코르텐밤색': '1219,607', '헤어진회': '1219,607,518', '헤어연회': '1219,607',
                '헤어골드': '1219,607', '빅징크': '1219', '라인메탈 1.0*0.5': '1150', '라인메탈 1.0*1.0': '1150', '골드메탈': '1150', '콘크리트': '1150',
...
def itemtype(name):
    ...
    sang = ['실리콘', '일자캡', '볼트', '지붕캡', 'PVC까치발', '까치발볼트', '방화문', '창호', '행거도어', '도어/창호','칼라피스','우레탄폼']
...
def renamebuja(names):
    r_name = names
    rename = {'스크류볼트': '볼트', '물홈통': '이형후레싱', '받침대': 'PVC까치발', '코너커버': '코너카바','코너바':'코너카바', '유도모음집': '유도모임통', '반도': '선홈통반도',
